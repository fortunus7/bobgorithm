  ...
  return (
    <div className="flex justify-center py-4">
      <motion.button
        ...
        onClick={handleClick}
        disabled={isSpinning}
        className="relative w-72 h-72 rounded-full bg-peach flex items-center justify-center babi-shadow cursor-pointer border-0 outline-none overflow-visible"
      >
        <img
          src={babiImg}
          alt="바비 캐릭터"
          className="w-[180%] h-[180%] object-contain drop-shadow-md"
        />
        {!isSpinning && (
          <motion.span
            initial={{ opacity: 0 }}
