...
const RecommendationResult = () => {
  ...
  const historyEntry = currentRecommendation
    ? history.find(h => h.restaurant.id === currentRecommendation.id)
    : undefined;
      ...
      {currentRecommendation && (
        ...
        >
          ...
          >
            ...
            <p className="text-center text-2xl font-bold text-primary -mt-6 mb-4 relative z-10">제가 골라 드렸어요 🍽️</p>
            <div className="flex justify-between items-start mb-4 relative z-10">
              ...
              <button 
                ...
                className="p-1.5 rounded-full bg-muted hover:bg-muted/80 transition-colors cursor-pointer"
                aria-label="결과 닫기"
              >
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span className="truncate">{currentRecommendation.address}</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <div className="flex gap-3 mt-auto">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl bg-muted text-muted-foreground font-semibold hover:bg-muted/80 transition-colors"
              >
                <Share2 size={18} />
                공유
              </button>
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors"
              >
                <Navigation size={18} />
                길찾기
              </button>
